...
/// <summary>
/// Extensions for handling HTML files via <see cref="IApiService"/> requests
/// </summary>
public static class HttpExtensions
{
    ...
    {
        using var resp = await builder.Result() ?? throw new NullReferenceException($"Request returned null!");
