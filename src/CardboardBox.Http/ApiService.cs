...
public interface IApiService
{
    ...
    /// <param name="config">Any optional configuration necessary</param>
    /// <returns>A task representing the results of the request</returns>
    Task<TResult?> Delete<TResult, TData>(string url, TData data, Action<HttpRequestMessage>? config = null);
    ...
    /// <param name="config">Any optional configuration necessary</param>
    /// <returns>A task representing the results of the request</returns>
    Task<HttpStatusResult<TSuccess, TFailure>> Delete<TSuccess, TFailure, TData>(string url, TData data, Action<HttpRequestMessage>? config = null);
    ...
    /// <param name="config">Any optional configuration necessary</param>
    /// <returns>A task representing the results of the request</returns>
    Task<T?> Delete<T>(string url, (string key, string val)[] formData, Action<HttpRequestMessage>? config = null);
    ...
    /// <param name="config">Any optional configuration necessary</param>
    /// <returns>A task representing the results of the request</returns>
    Task<HttpStatusResult<TSuccess, TFailure>> Delete<TSuccess, TFailure>(string url, (string key, string val)[] data, Action<HttpRequestMessage>? config = null);
...
public class ApiService : IApiService
{
    ...
    /// <param name="method">The method used for this HTTP request</param>
    /// <returns>An instance of the <see cref="IHttpBuilder"/></returns>
    public virtual IHttpBuilder Create(string url, IJsonService json, string method = VERB_GET) => new HttpBuilder(_httpFactory, json, _cache, _logger).Method(method).Uri(url);
    ...
    /// <param name="method">The method used for this HTTP request</param>
    /// <returns>An instance of the <see cref="IHttpBuilder"/></returns>
    public virtual IHttpBuilder Create(string url, string method = VERB_GET) => Create(url, _json, method);
    ...
    {
        return Create(url).With(config).FailGracefully().Result<TSuccess, TFailure>();
    }
    ...
    {
        return Create(url).With(config).Cache(true, cacheDir, cacheMin).FailGracefully().Result<TSuccess, TFailure>();
    }
    ...
    {
        return Create(url, VERB_POST).With(config).Body(data).Result<TResult>();
    }
    ...
    {
        return Create(url, VERB_POST).With(config).Body(data).FailGracefully().Result<TSuccess, TFailure>();
    }
    ...
    {
        return Create(url, VERB_POST).With(config).Body(formData).Result<T>();
    }
    ...
    {
        return Create(url, VERB_PUT).With(config).Body(data).Result<TResult>();
    }
    ...
    {
        return Create(url, VERB_PUT).With(config).Body(data).FailGracefully().Result<TSuccess, TFailure>();
    }
    ...
    {
        return Create(url, VERB_PUT).With(config).Body(formData).Result<T>();
    }
    ...
    {
        return Create(url, VERB_DELETE).With(config).Result<T>();
    }
    ...
    {
        return Create(url, VERB_DELETE).With(config).FailGracefully().Result<TSuccess, TFailure>();
    }
    ...
    /// <param name="config">Any optional configuration necessary</param>
    /// <returns>A task representing the results of the request</returns>
    public Task<TResult?> Delete<TResult, TData>(string url, TData data, Action<HttpRequestMessage>? config = null)
    {
        return Create(url, VERB_DELETE).With(config).Body(data).Result<TResult>();
    }
    ...
    /// <param name="config">Any optional configuration necessary</param>
    /// <returns>A task representing the results of the request</returns>
    public Task<HttpStatusResult<TSuccess, TFailure>> Delete<TSuccess, TFailure, TData>(string url, TData data, Action<HttpRequestMessage>? config = null)
    {
        return Create(url, VERB_DELETE).With(config).Body(data).FailGracefully().Result<TSuccess, TFailure>();
    }
    ...
    /// <param name="config">Any optional configuration necessary</param>
    /// <returns>A task representing the results of the request</returns>
    public Task<T?> Delete<T>(string url, (string key, string val)[] formData, Action<HttpRequestMessage>? config = null)
    {
        return Create(url, VERB_DELETE).With(config).Body(formData).Result<T>();
    }
    ...
    /// <param name="config">Any optional configuration necessary</param>
    /// <returns>A task representing the results of the request</returns>
    public Task<HttpStatusResult<TSuccess, TFailure>> Delete<TSuccess, TFailure>(string url, (string key, string val)[] data, Action<HttpRequestMessage>? config = null)
    {
        return Create(url, VERB_DELETE).With(config).Body(data).FailGracefully().Result<TSuccess, TFailure>();
    }
    #endregion
